...
function highlightFollowedContent(obj) {
	...
	newItem.innerHTML = '<div class="block-container no-side"><div class="block-inner"><div class="content-inner"><div class="list-container"><div class="list-inner"><h2 class="list-title"><a href="screen://myft/follow" class="right-icon">修改设置</a><a class="list-link" href="screen://myft/follow">我的FT</a></h2><div class="items">'+ myFTFollowHTML +'</div></div></div><div class="clearfloat block-bottom"></div></div></div><div class="clearfloat"></div></div></div>';
