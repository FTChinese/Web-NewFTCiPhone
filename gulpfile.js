...
gulp.task('grab', async () => {
  await Promise.all([
    ...
    getUrltoFile('https://d1jz9j0gyf09j1.cloudfront.net/channel/bestofenglish.html?webview=ftcapp&bodyonly=yes&newad=yes&v=1', './app/templates/dailyenglishbackup.html'),
